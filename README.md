...
| Author        | 発表者・著者        | 2名以上の時は「,」で区切る。著者には〇や下線は付けない。筆頭著者は先頭、共著者の順番は変更しない。日本語の場合苗字と名前の間にスペースは入れない。  日本語の例：夏目やよい, 長尾知生子, 水口賢司  英語の例：Kenji Mizuguchi, Attayeb Mohsen, Lokesh  P. Tripathi |
| Publication   | 学会名              | 日本語の場合：公式HPなどに記載されている正式名を入力する。（学会名だけではなく、第〇回、年会/講演会などの情報も）  英語の場合：公式HPなどに記載されている略称を入力、なければ略さずに入力  日本語例：CBI学会2020年大会、日本薬物動態学会第35回年会  英語例：ISMB/ECCB 2019、ISDSB 2019 |
| **Date**      | **発表日**          | **YYYY/MM/DD**                                               |
| **Extra**     | **開催場所**        | **国内の場合：都道府県名  国外の場合：都市名（国名）  オンライン開催の場合：オンライン  国内の例：東京、大阪　国外の例：ジュネーブ（スイス）** |
...
| Title       | タイトル              |                                                              |
| Author      | 発表者・著者          | 2名以上の時は「,」で区切る。著者には〇や下線は付けない。筆頭著者は先頭、共著者の順番は変更しない。日本語の場合苗字と名前の間にスペースは入れない。  日本語の例：夏目やよい, 長尾知生子, 水口賢司  英語の例：Kenji Mizuguchi, Attayeb Mohsen, Lokesh  P. Tripathi |
| Publication | 雑誌/新聞/書籍名      |                                                              |
| Date        | 発行日                | YYYY/MM/DD                                                   |
| **Extra**   | **URL、発行番号など** | **インターネット媒体の場合：URL  新聞の場合：号番号（第号）  雑誌の場合：巻数/号数・ページ番号  書籍：出版社名・編者または監修者名・ページ番号** |
...
- _____international_conference（国際学会）
- _____domestic_conference（国内学会）
