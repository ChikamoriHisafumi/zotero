...
| Author        | 発表者<br />著者    | ・2名以上の時は「,」で区切る。<br />・著者には〇や下線は付けない。<br />・複数著者の場合はauthorのカラムを追加し1カラム1人になるように入力する。<br />・著者の順番通りに上から登録する（筆頭著者は最も上のカラム）。<br />・日本語の場合苗字と名前の間にスペースは入れない。<br />・日本語の例：夏目やよい, 長尾知生子, 水口賢司<br />・英語の例：Kenji Mizuguchi, Attayeb Mohsen, Lokesh  P. Tripathi |
...
| Title       | タイトル                   |                                                              |
| Author      | 発表者<br />著者           | ・2名以上の時は「,」で区切る。著者には〇や下線は付けない。<br />・複数著者の場合はauthorのカラムを追加し1カラム1人になるように入力する（必要な場合のみ）。<br />・筆頭著者は先頭、共著者の順番は変更しない。<br />・日本語の場合苗字と名前の間にスペースは入れない。  <br />・日本語の例：夏目やよい, 長尾知生子, 水口賢司  英語の例：Kenji Mizuguchi, Attayeb Mohsen, Lokesh  P. Tripathi |
